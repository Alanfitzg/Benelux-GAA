-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('SUPER_ADMIN', 'CLUB_ADMIN', 'USER');

-- AlterTable
ALTER TABLE "Club" ADD COLUMN     "latitude" DOUBLE PRECISION,
ADD COLUMN     "longitude" DOUBLE PRECISION,
ADD COLUMN     "teamTypes" TEXT[] DEFAULT ARRAY[]::TEXT[];
