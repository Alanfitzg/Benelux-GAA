...
export function WelcomeEmail({ userName, clubName, clubCrestUrl }: WelcomeEmailProps) {
  return (
    <div style={{
      ...
      <div style={{ padding: '30px 20px' }}>
          ...
          <div style={{
            ...
            <div style={{ fontSize: '14px', lineHeight: '1.5' }}>
              <p style={{ margin: '0 0 5px 0' }}>
                <strong>Ireland:</strong> Experience GAA at its source with 500+ clubs
              </p>
              <p style={{ margin: '0 0 5px 0' }}>
                <strong>USA & Canada:</strong> Join the thriving North American GAA scene
              </p>
              <p style={{ margin: '0 0 5px 0' }}>
                <strong>Australia:</strong> Combine GAA with incredible travel experiences
              </p>
              <p style={{ margin: '0 0 5px 0' }}>
                <strong>Europe:</strong> Play in tournaments from Barcelona to Berlin
              </p>
              <p style={{ margin: '0' }}>
                <strong>Middle East & Asia:</strong> Discover emerging GAA communities
              </p>
            </div>
          </div>
        </div>
        ...
        <div style={{
          ...
          <p style={{
            ...
            <strong>Need Help?</strong> Our team is here to assist with tournament registrations, travel planning, or connecting with clubs. Just reply to this email!
          </p>
        </div>
