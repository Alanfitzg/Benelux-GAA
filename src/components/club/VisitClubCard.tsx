...
export default function VisitClubCard({
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
          ...
          <div className="bg-gray-50 rounded-lg p-3">
            ...
            {isDayPassExpanded && (
              <div className="mt-3 pt-3 border-t border-gray-200 text-sm text-gray-600 space-y-3">
                ...
                <button
                  type="button"
                  onClick={() => setShowNotIncludedModal(true)}
                  className="flex items-center gap-1 text-xs text-gray-500 hover:text-gray-700 mt-2 underline"
                >
                  What&apos;s not included?
                </button>
              </div>
      ...
      {/* Not Included Modal */}
      {showNotIncludedModal && (
        <div
          className="fixed inset-0 z-50 flex items-center justify-center p-4"
          onClick={() => setShowNotIncludedModal(false)}
        >
          {/* Backdrop */}
          ...
          >
            ...
            <div className="p-5 space-y-4">
              <p className="text-sm text-gray-600">
                The Day-Pass covers playing with the club, but these are
              ...
              <ul className="space-y-3">
                {[
                  {
                    title: "Accommodation",
                    desc: "Hotels and hostels near the club",
