        ...
        >
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">Review and approve pending club registrations</p>
            </div>
          </div>
        </Link>
        ...
        >
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">View and analyze custom trip requests</p>
            </div>
          </div>
        </Link>
        ...
        >
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">Review and approve club admin access requests</p>
            </div>
          </div>
        </Link>
        ...
        >
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">Manage club calendars, events, and interest submissions</p>
            </div>
          </div>
        </Link>
