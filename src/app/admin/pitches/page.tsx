  ...
  const fetchData = async () => {
    ...
    try {
      ...
      if (pitchesRes.ok) {
        ...
        const uniqueCities = [...new Set(pitchesData.map((p: PitchLocation) => p.city))];
      ...
      // Fetch requests
      const requestsRes = await fetch("/api/pitch-locations/request?status=PENDING");
      if (requestsRes.ok) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8 flex justify-between items-start">
          <div>
            ...
            <p className="text-gray-600 mt-2">Manage training pitches and location requests</p>
          </div>
          ...
          <>
                  ...
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      ...
                      <div className="space-y-1 text-sm text-gray-600">
                        ...
                        <p>
                          Created by: {pitch.creator?.name || pitch.creator?.email || 'Unknown'}
                        </p>
                        <p>
            ...
            {filteredPitches.length === 0 && (
              <div className="text-center py-12 bg-white rounded-lg">
                ...
                <p className="text-gray-600">No pitches found matching your filters</p>
              </div>
            )}
          </>
        )}
            ...
            {requests.length === 0 ? (
              ...
              requests.map((request) => (
                ...
                >
                  <div className="flex justify-between items-start">
                    <div>
                      <h3 className="text-lg font-semibold mb-2">{request.pitchName}</h3>
                      <div className="space-y-1 text-sm text-gray-600">
