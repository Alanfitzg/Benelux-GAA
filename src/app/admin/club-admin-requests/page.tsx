...
import { Shield, Clock, CheckCircle, XCircle, User, MapPin, Calendar, AlertCircle } from 'lucide-react';
...
export default function ClubAdminRequestsPage() {
  ...
  const fetchRequests = useCallback(async () => {
    try {
      const response = await fetch(`/api/admin/club-admin-requests?status=${selectedStatus}`);
  ...
  const handleReviewRequest = async (requestId: string, action: 'approve' | 'reject', rejectionReason?: string) => {
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-gray-900">Club Admin Requests</h1>
                  <p className="text-gray-600">Manage requests for club administrative access</p>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-4 mb-4">
                        {/* Club Image */}
                        <Image
                          src={request.club.imageUrl || "https://gaelic-trips-bucket.s3.eu-west-1.amazonaws.com/placeholder-crest.png"}
                        ...
                        {/* Club Info */}
                        <div>
                          <h3 className="text-lg font-semibold text-gray-900">{request.club.name}</h3>
                      ...
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                          ...
                          <span className="text-gray-600 ml-2">({request.user.email})</span>
                        </div>
                      </div>
