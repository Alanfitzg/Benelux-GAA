...
async function sendPriorityWeekendAlerts(priorityWeekend: { date: Date; message: string }) {
  ...
  console.log(`Sending priority weekend alerts to ${clubs.length} clubs for date: ${priorityWeekend.date}`);
