...
async function getIrishCountiesHandler(request: Request) {
  try {
    ...
    const counties = IRISH_COUNTIES[provinceCode as keyof typeof IRISH_COUNTIES];
...
export const GET = withRateLimit(RATE_LIMITS.PUBLIC_API, getIrishCountiesHandler);