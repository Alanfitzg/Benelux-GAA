...
export default function EventReportPage({
  ...
  const [existingReport, setExistingReport] = useState<EventReport | null>(
    null
  );
              ...
              initialData={
                existingReport
                  ? {
                      ...
                      runnerUpTeamId:
                        existingReport.runnerUpTeamId || undefined,
                      thirdPlaceTeamId:
                        existingReport.thirdPlaceTeamId || undefined,
                      participatingTeams:
                        (existingReport.participatingTeams as Array<{
                          teamId: string;
                          teamName: string;
                          clubName: string;
                      ...
                      playerAwards:
                        (existingReport.playerAwards as Array<{
                          awardType: string;
                          playerName: string;
                          teamName: string;
                        }>) || undefined,
                      amenitiesProvided:
                        existingReport.amenitiesProvided || undefined,
                      eventHighlights:
                        existingReport.eventHighlights || undefined,
