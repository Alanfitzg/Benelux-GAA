      ...
      <main className="flex-1 pt-20 pb-8 sm:pt-24 sm:pb-16 md:pt-28">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <section className="mb-16">
            <div className="bg-gradient-to-br from-[#1a3a4a] to-[#2B9EB3] rounded-2xl p-5 sm:p-8 md:p-12">
                ...
                <div className="text-center md:text-left">
                  ...
                  <div className="flex flex-wrap gap-3 justify-center md:justify-start">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 px-6 py-3 bg-white/10 text-white border border-white/40 rounded-lg font-semibold hover:bg-white/20 transition-colors"
                    >
                      Jobs @ Breagh
                      <ExternalLink size={18} />
                    </a>
