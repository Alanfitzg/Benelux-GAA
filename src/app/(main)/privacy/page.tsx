...
export const metadata: Metadata = {
  ...
  description:
    "Privacy policy and data protection information for Gaelic Trips",
};
            ...
            <section>
              ...
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-start">
                  <span className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0"></span>
                  <span>
                    <strong>Platform Operation:</strong> To provide access to
                    our services and manage your account
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0"></span>
                ...
                <li className="flex items-start">
                  <span className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0"></span>
                  <span>
                    <strong>Security:</strong> To protect our platform and users
            ...
            <section>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <p className="text-gray-700 text-sm">
                    Used for advertising and remarketing purposes. These are
              ...
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-start">
                  ...
                  <span>
                    ...
                    who help operate our platform (hosting, payment processing)
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0"></span>
                ...
                <li className="flex items-start">
                  <span className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0"></span>
                  <span>
                    <strong>Club Information:</strong> Basic contact details
                    with relevant clubs for event coordination
                  </span>
                </li>
              </ul>
            </section>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <ul className="space-y-3 text-gray-700">
                  ...
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>
                      <strong>Portability:</strong> Transfer your data elsewhere
                    </span>
                  </li>
                </ul>
                <ul className="space-y-3 text-gray-700">
