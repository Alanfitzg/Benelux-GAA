...
const resources = [
  ...
  },
  {
    ...
    description:
      "Player registration via Foireann, transfers, and membership information.",
    icon: RefreshCcw,
    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-1 pt-20 pb-8 sm:pt-24 sm:pb-16 md:pt-28">
        <div className="max-w-5xl mx-auto px-4">
          ...
          {/* Resource Cards */}
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-10 md:mb-16">
          ...
          {/* External Links */}
          <div className="bg-gray-50 rounded-xl p-5 sm:p-8">
