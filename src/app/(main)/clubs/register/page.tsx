...
export default function RegisterClubPage() {
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 flex items-center justify-center">
        <div className="max-w-md mx-auto text-center p-8">
          ...
          <p className="text-gray-600 mb-6">
            You need to sign in to register a club. This helps us verify club
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    const data: ClubFormData = {
      ...
      location,
      internationalUnitText:
        (form.elements.namedItem("internationalUnit") as HTMLInputElement)
          ?.value || "",
      region:
        (form.elements.namedItem("region") as HTMLInputElement)?.value || null,
      subRegion:
        (form.elements.namedItem("subRegion") as HTMLInputElement)?.value ||
        null,
    ...
    if (res.ok) {
      ...
      setImageUrl(null);
      toast.success(
        "Club registered successfully! Your club will be reviewed and approved shortly."
      );
        ...
        <div className="relative container mx-auto px-6 py-16">
          ...
          >
            ...
            <p className="text-xl text-blue-100 max-w-2xl mx-auto">
              Join the global Gaelic community and connect with players and
              clubs worldwide.
            </p>
          </motion.div>
        </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-green-700 space-y-1">
                        ...
                        <p>
                          Our admin team will review your submission and notify
                          ...
                          >
                            ...
                            <div className="flex-1">
                              ...
                              <input
                                ...
                                onChange={(e) =>
                                  updateSocialMedia(platformId, e.target.value)
                                }
                    ...
                    <div className="flex items-center mb-6">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 mt-1">
                          Please provide details of the person we can contact
                          about this club
                        </p>
                      </div>
                    </div>
                        ...
                        <div className="bg-blue-100 rounded-xl p-4">
                          <label className="flex items-start space-x-3 cursor-pointer">
                            <input
                              ...
                              onChange={(e) =>
                                setIsContactWilling(e.target.checked)
                              }
                              className="mt-1 w-5 h-5 text-primary border-2 border-gray-300 rounded focus:ring-primary focus:ring-offset-2"
                            />
                            <span className="text-sm text-gray-700 leading-relaxed">
                              <strong>
                                I am willing to be the Point of Contact
                              </strong>{" "}
                              for this club and consent to being contacted about
                              club-related matters, tournament opportunities,
