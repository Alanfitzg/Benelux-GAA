                        ...
                        <div className="flex items-center gap-2 mt-2">
                          <div className="flex items-center gap-1">
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className={`w-6 h-6 flex items-center justify-center rounded-full text-white ${club.facebook ? "bg-[#1877F2]" : "bg-gray-300 pointer-events-none opacity-40"}`}
                            >
                              <svg
                                className="w-3 h-3"
                                fill="currentColor"
                            ...
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className={`w-6 h-6 flex items-center justify-center rounded-full text-white ${club.instagram ? "bg-[#E4405F]" : "bg-gray-300 pointer-events-none opacity-40"}`}
                            >
                              <svg
                                className="w-3 h-3"
                                fill="currentColor"
                            ...
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className={`w-6 h-6 flex items-center justify-center rounded-full text-white ${club.twitter ? "bg-black" : "bg-gray-300 pointer-events-none opacity-40"}`}
                            >
                              <svg
                            ...
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className={`w-6 h-6 flex items-center justify-center rounded-full text-white ${club.tiktok ? "bg-black" : "bg-gray-300 pointer-events-none opacity-40"}`}
                            >
                              <svg
                                className="w-3 h-3"
                                fill="currentColor"
                    ...
                    <div className="flex items-center justify-between mt-4 pt-4 border-t border-gray-100">
                      <div className="flex items-center gap-2">
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className={`w-8 h-8 flex items-center justify-center rounded-lg text-white ${club.facebook ? "bg-[#1877F2]" : "bg-gray-300 pointer-events-none opacity-40"}`}
                          title="Facebook"
                        >
                          <svg
                            className="w-4 h-4"
                        ...
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className={`w-8 h-8 flex items-center justify-center rounded-lg text-white ${club.instagram ? "bg-[#E4405F]" : "bg-gray-300 pointer-events-none opacity-40"}`}
                          title="Instagram"
                        >
                          <svg
                            className="w-4 h-4"
                        ...
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className={`w-8 h-8 flex items-center justify-center rounded-lg text-white ${club.twitter ? "bg-black" : "bg-gray-300 pointer-events-none opacity-40"}`}
                          title="X (Twitter)"
                        >
                          <svg
                        ...
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className={`w-8 h-8 flex items-center justify-center rounded-lg text-white ${club.tiktok ? "bg-black" : "bg-gray-300 pointer-events-none opacity-40"}`}
                          title="TikTok"
                        >
                          <svg
                            className="w-4 h-4"
