                ...
                {hasConsent ? (
                  <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                    <p className="text-blue-800">
                      <strong>Current Status:</strong> You have set your cookie
                      preferences.
                    </p>
                  </div>
                ) : (
                  <div className="mb-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                    <p className="text-yellow-800">
                      <strong>No Preferences Set:</strong> Please configure your
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <p className="text-gray-600 mb-3">
                          ...
                          function properly. They enable core functionality such
                          as security, network management, and accessibility.
                        </p>
                        <div className="text-sm text-gray-500">
                          <strong>Examples:</strong> Authentication tokens,
                  ...
                  <div className="p-6 border-2 border-gray-200 rounded-xl hover:border-primary/20 transition-colors">
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <div className="text-sm text-gray-500">
                          <strong>Examples:</strong> Page views, time spent,
                          user interactions, error tracking
                        </div>
                      </div>
                      <div className="ml-6">
                        <button
                  ...
                  <div className="p-6 border-2 border-gray-200 rounded-xl hover:border-primary/20 transition-colors">
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <p className="text-gray-600 mb-3">
                          Used to track visitors across websites. The intention
                          is to display ads that are relevant and engaging for
                          the individual user.
                        </p>
                        <div className="text-sm text-gray-500">
                          <strong>Examples:</strong> Advertising pixels, social
                          media integrations, remarketing tags
                        </div>
                      </div>
                      <div className="ml-6">
                        <button
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6">
                ...
                <p className="text-gray-600 text-sm">
                  ...
                  contact us through our privacy policy page.
                </p>
              </div>
            </div>
          </div>
