        ...
        <div className="w-full max-w-2xl mx-auto text-center">
          ...
          {sent ? (
            ...
            <button
              ...
              className="inline-flex items-center gap-2 bg-primary text-white px-6 py-3 md:px-8 md:py-4 rounded-lg font-semibold hover:bg-primary-dark transition-colors text-base md:text-lg"
            >
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 mb-3 md:mb-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2.5 md:px-4 md:py-2 bg-white/10 border border-white/20 rounded-lg text-white text-sm md:text-base placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
              ...
              <div className="mb-4 md:mb-6">
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2.5 md:px-4 md:py-2 bg-white/10 border border-white/20 rounded-lg text-white text-sm md:text-base placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent resize-none"
              ...
              <div className="flex flex-col-reverse md:flex-row gap-2 md:gap-3">
                ...
                <button
                  type="submit"
                  disabled={sending}
                  className="flex-1 flex items-center justify-center gap-2 bg-primary text-white px-4 py-2.5 md:px-6 md:py-3 rounded-lg font-semibold text-sm md:text-base hover:bg-primary-dark transition-colors disabled:opacity-50"
                >
                  {sending ? (
                    <>
