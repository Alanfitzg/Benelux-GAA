      ...
      <div className="relative z-10 container mx-auto px-4 py-4 md:py-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 md:gap-6">
          ...
          <Link
            ...
            className="group bg-gradient-to-br from-blue-500 to-indigo-600 p-3 md:p-8 rounded-lg md:rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-blue-400"
          >
            <div className="flex items-center space-x-3 md:space-x-4">
              <span className="text-2xl md:text-3xl group-hover:scale-110 transition-transform flex-shrink-0">
                📊
          ...
          <Link
            href="/admin/europe-county-board"
            className="group bg-gradient-to-br from-blue-600 to-indigo-700 p-3 md:p-8 rounded-lg md:rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-blue-500"
          >
            <div className="flex items-center space-x-3 md:space-x-4">
              <span className="text-2xl md:text-3xl group-hover:scale-110 transition-transform flex-shrink-0">
                🇪🇺
              ...
              <div>
                ...
                <p className="text-white/80 text-xs md:text-base mt-0.5 md:mt-1">
                  Board member accounts & credentials
                </p>
              </div>
            </div>
          </Link>
          ...
          <Link
            href="/admin/youth"
            className="group bg-gradient-to-br from-amber-500 to-orange-600 p-3 md:p-8 rounded-lg md:rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-amber-400"
          >
            <div className="flex items-center space-x-3 md:space-x-4">
              <span className="text-2xl md:text-3xl group-hover:scale-110 transition-transform flex-shrink-0">
                🏃
              ...
              <div>
                ...
                <p className="text-white/80 text-xs md:text-base mt-0.5 md:mt-1">
                  Manage youth events, clubs & communications
                </p>
              </div>
            </div>
          </Link>
          ...
          <Link
            href="/admin/social-gaa"
            className="group bg-gradient-to-br from-pink-500 to-purple-600 p-3 md:p-8 rounded-lg md:rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-pink-400"
          >
            <div className="flex items-center space-x-3 md:space-x-4">
              <span className="text-2xl md:text-3xl group-hover:scale-110 transition-transform flex-shrink-0">
                🎉
              ...
              <div>
                ...
                <p className="text-white/80 text-xs md:text-base mt-0.5 md:mt-1">
                  G4MO, Dads & Lads, and social tournaments
                </p>
              </div>
            </div>
          </Link>
