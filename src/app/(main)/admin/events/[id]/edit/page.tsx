    ...
    fetch(`${URLS.API.EVENTS}/${eventId}`)
      ...
      .then((data) => {
        ...
        if (data.pitchLocations && data.pitchLocations.length > 0) {
          setSelectedPitches(
            data.pitchLocations.map(
              (p: { pitchLocationId: string }) => p.pitchLocationId
            )
          );
                      ...
                      <label className="block text-sm font-semibold text-gray-700 mb-3">
                        ...
                        {event.eventType === "Tournament" && (
                          <span className="ml-2 text-xs text-gray-500">
                            Multiple pitches can be selected for tournaments
                          </span>
                        )}
                      </label>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="md:col-span-2">
                      ...
                      <p className="text-xs text-gray-500 mt-2">
                        Associate this event with a specific club for management
                        and branding
                      </p>
                    </div>
                ...
                <div className="bg-white rounded-lg p-8 border border-gray-200 shadow-sm">
                  ...
                  <div className="grid grid-cols-1 gap-6">
                    ...
                    <div>
                      ...
                      />
                      <p className="text-xs text-gray-500 mt-2">
                        Upload a high-quality image to showcase your event.
                ...
                <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                  <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                    <div className="flex items-center gap-3 text-sm text-gray-600">
                      ...
                      <span>
                        Changes will be saved immediately and affect how users
                        see your event
                      </span>
                    </div>
